...
if (!file.exists("presentations/test_sample_cfo_tacc_scatter_3x2.mp4")) {
  p <- create_scatter_video(test_sample, "Test sample", x="cfo", y="tacc", 
                            ...
                            loess = TRUE,
                            filename = "presentations/test_sample_cfo_tacc_scatter_3x2.mp4",
                            height = 1000, width = 1500, units = "px", fsize = 24, 
                            nframes = 100, fps = 25)
} 
```
...
\includemedia[
  width = \textwidth, height = 0.666\textwidth, passcontext,
  addresource=test_sample_cfo_tacc_scatter_3x2.mp4,
  deactivate=onclick,
  flashvars={source=test_sample_cfo_tacc_scatter_3x2.mp4}
 ]{}{VPlayer.swf}
