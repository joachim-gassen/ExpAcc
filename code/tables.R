...
prepare_tab_full_model <- function(ys, format = "latex", feffects = rep("", 8), clusters = rep("", 8)) {
  tab <- prepare_regression_table(ys, dvs = rep("dd_adjr2", 8),
                                  idvs = list("time", 
                                              ...
                                              c("time", "cfo_mean", "cfo_sd", "cfo_skew", 
                                                "dcfo_acorr", "std_oi_pti", "dt_adjr2", "sgaint"),
                                              ...
                                              c("cfo_mean", "cfo_sd", "cfo_skew", 
                                                ...
                                                feffects = feffects, clusters = clusters)
  tab <- add_vif_to_reg_table(tab, 2:8, format) 
  return(tab)
}
